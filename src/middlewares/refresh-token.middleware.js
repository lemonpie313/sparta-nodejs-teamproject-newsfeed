...
export default async function (req, res, next) {
  try {
    ...
    if (!refreshToken) {
      ...
      try {
        //jwt 유효한지
        console.log("REFRESH_TOKEN_SECRET_KEY에 담긴것", process.env.REFRESH_TOKEN_SECRET_KEY)
    ...
    const isValidRefreshToken = existRefreshToken?.token && bcrypt.compareSync(refreshToken, existRefreshToken.token);
